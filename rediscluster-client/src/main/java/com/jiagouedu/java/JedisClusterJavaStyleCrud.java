...
public class JedisClusterJavaStyleCrud {
   private static JedisCluster jedis;

   static {
      Set<HostAndPort> jedisClusterNodes = new HashSet<HostAndPort>();
      jedisClusterNodes.add(new HostAndPort("192.168.0.31", 7000));
      jedisClusterNodes.add(new HostAndPort("192.168.0.31", 7001));
      jedisClusterNodes.add(new HostAndPort("192.168.0.32", 7000));
      jedisClusterNodes.add(new HostAndPort("192.168.0.32", 7001));
      jedisClusterNodes.add(new HostAndPort("192.168.0.33", 7000));
      jedisClusterNodes.add(new HostAndPort("192.168.0.33", 7001));
